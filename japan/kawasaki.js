...
function kawasaki() {
    ...
    const places = [
        { name: "Тематический парк Хантаун", coordinates: { lat: 35.5252, lng: 139.6983 } },
        { name: "Санкт-Николаевская набережная", coordinates: { lat: 35.5295, lng: 139.6926 } },
        { name: "Токио-Бэй Аква Лайн", coordinates: { lat: 35.5084, lng: 139.6966 } },
        { name: "Кавасаки-дайси", coordinates: { lat: 35.5335, lng: 139.6790 } },
        { name: "Кавасаки Гранд Сакурагаока Тира Туэ", coordinates: { lat: 35.5592, lng: 139.6179 } }
      ];
    ...
    const map = createMap(35.530906, 139.703051, places);
