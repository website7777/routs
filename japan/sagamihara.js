...
function sagamihara() {
    ...
    const places = [
        { name: "Озеро Сагами", coordinates: { lat: 35.5894, lng: 139.3976 } },
        { name: "Лес Мэндаи", coordinates: { lat: 35.6323, lng: 139.3349 } },
        { name: "Парк Сагамитихара", coordinates: { lat: 35.5606, lng: 139.3938 } },
        { name: "Музей Префектуры Канагава", coordinates: { lat: 35.5797, lng: 139.3569 } },
        { name: "Храм Хонко-джи", coordinates: { lat: 35.5509, lng: 139.3896 } }
      ];
    ...
    const map = createMap(35.553144, 139.354690, places);
