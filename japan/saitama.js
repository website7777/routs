...
function saitama() {
    ...
    const places = [
        { name: "Сайтама Супер Арена", coordinates: { lat: 35.8944, lng: 139.6272 } },
        { name: "Храм Хокки Сайтама", coordinates: { lat: 35.8716, lng: 139.6412 } },
        { name: "Музей Сайтама", coordinates: { lat: 35.8590, lng: 139.6446 } },
        { name: "Парк Омия", coordinates: { lat: 35.9200, lng: 139.6284 } },
        { name: "Замок Сайтама", coordinates: { lat: 35.8881, lng: 139.6241 } }
      ];
    ...
    const map = createMap(35.861729, 139.645482, places);
