...
function kobe() {
    ...
    const places = [
        { name: "Залив Аватано", coordinates: { lat: 34.6824, lng: 135.2256 } },
        { name: "Зоопарк Одзаки", coordinates: { lat: 34.6662, lng: 135.1706 } },
        { name: "Гора Мая", coordinates: { lat: 34.7006, lng: 135.2191 } },
        { name: "Храм Икунухи", coordinates: { lat: 34.7026, lng: 135.1917 } },
        { name: "Рынок Нандзэнзака", coordinates: { lat: 34.6914, lng: 135.1945 } }
      ];
      
      
      
  
    const map = createMap(34.693738, 135.195511, places);
