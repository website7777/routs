...
function okayama() {
    ...
    const places = [
        { name: "Замок Окаяма", coordinates: { lat: 34.6617, lng: 133.9344 } },
        { name: "Королевский ботанический сад Коракуэн", coordinates: { lat: 34.6667, lng: 133.9378 } },
        { name: "Музей Таиши", coordinates: { lat: 34.6611, lng: 133.9359 } },
        { name: "Храм Рокубэнсё", coordinates: { lat: 34.6664, lng: 133.9442 } },
        { name: "Парк Коракуэн", coordinates: { lat: 34.6653, lng: 133.9413 } }
      ];
    ...
    const map = createMap(34.661311, 133.934077, places);
