...
function yokkaichi() {
    ...
    const places = [
        { name: "Йоккаидо Шинкансэн Трейн", coordinates: { lat: 35.0183, lng: 135.7788 } },
        { name: "Горячие источники Ноборибэцу", coordinates: { lat: 35.5334, lng: 139.6966 } },
        { name: "Парк Одори", coordinates: { lat: 43.0618, lng: 141.3545 } },
        { name: "Цветочные часы Йоккаидо", coordinates: { lat: 43.0676, lng: 141.3524 } },
        { name: "Фестиваль снега в Саппоро", coordinates: { lat: 43.0686, lng: 141.3510 } }
      ];
    ...
    const map = createMap(35.045680, 136.879187, places);
