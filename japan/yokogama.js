...
function yokohama() {
    ...
    const places = [
        { name: "Санкт-Николаевская православная церковь", coordinates: { lat: 35.4444, lng: 139.6514 } },
        { name: "Чингуйская улица", coordinates: { lat: 35.4437, lng: 139.6380 } },
        { name: "Парк Йокогама", coordinates: { lat: 35.4444, lng: 139.6364 } },
        { name: "Морской парк Хаккеидзима", coordinates: { lat: 35.6458, lng: 139.6488 } },
        { name: "Санкт-Николаевская набережная", coordinates: { lat: 35.4572, lng: 139.6463 } }
      ];
      
    
  
    const map = createMap(35.443707, 139.638031, places);
