...
function hiroshima() {
    ...
    const places = [
        { name: "Мирный мемориальный парк Хиросимы", coordinates: { lat: 34.3955, lng: 132.4536 } },
        { name: "Замок Хиросимы", coordinates: { lat: 34.3945, lng: 132.4619 } },
        { name: "Остров Миядзима", coordinates: { lat: 34.2967, lng: 132.3195 } },
        { name: "Храм Хакусай-дзи", coordinates: { lat: 34.3865, lng: 132.4504 } },
        { name: "Хиросимская гора Митакэ", coordinates: { lat: 34.3558, lng: 132.4255 } }
      ];
    ...
    const map = createMap(34.385289, 132.455306, places);
