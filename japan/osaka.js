...
function osaka() {
    ...
    const  places = [
        { name: "Замок Осака", coordinates: { lat: 34.6877, lng: 135.5262 } },
        { name: "Универсальные студии Осаки", coordinates: { lat: 34.6654, lng: 135.4323 } },
        { name: "Храм Шитеннодзи", coordinates: { lat: 34.6546, lng: 135.5182 } },
        { name: "Рынок Дотонбори", coordinates: { lat: 34.6684, lng: 135.5023 } },
        { name: "Осакская акваариум", coordinates: { lat: 34.6547, lng: 135.4286 } }
      ];
      
    
  
    const map = createMap(34.693738, 135.502165, places);
