...
function hamamatsu() {
    ...
    const places = [
        { name: "Храм Миягава", coordinates: { lat: 34.7161, lng: 137.7395 } },
        { name: "Замок Хамамацу", coordinates: { lat: 34.7053, lng: 137.7273 } },
        { name: "Парк Городской Торговли", coordinates: { lat: 34.7061, lng: 137.7317 } },
        { name: "Музей искусства и культуры", coordinates: { lat: 34.7206, lng: 137.7211 } },
        { name: "Храм Хамамацу", coordinates: { lat: 34.7022, lng: 137.7362 } }
      ];
    ...
    const map = createMap(34.710181, 137.725580, places);
