...
function kyoto() {
    ...
    const Places = [
        { name: "Золотой храм Кинкакудзи", coordinates: { lat: 35.0394, lng: 135.7292 } },
        { name: "Храм Кийомизу-дэра", coordinates: { lat: 34.9949, lng: 135.7850 } },
        { name: "Философская тропа", coordinates: { lat: 35.0275, lng: 135.8010 } },
        { name: "Арбат Понтодзи", coordinates: { lat: 35.0035, lng: 135.7681 } },
        { name: "Геиша-квартал Гион", coordinates: { lat: 35.0021, lng: 135.7708 } }
      ];
      
      
      
  
    const map = createMap(35.011636, 135.768029, places);
