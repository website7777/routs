...
function kurashiki() {
    ...
    const places = [
        { name: "Парк Курасики", coordinates: { lat: 34.5873, lng: 133.7747 } },
        { name: "Морской музей Курасики", coordinates: { lat: 34.5792, lng: 133.7694 } },
        { name: "Храм Куцукихама", coordinates: { lat: 34.5749, lng: 133.7716 } },
        { name: "Парк Тосанмицу", coordinates: { lat: 34.5885, lng: 133.7686 } },
        { name: "Заповедник Макинами", coordinates: { lat: 34.5618, lng: 133.7479 } }
      ];
    ...
    const map = createMap(34.601211, 133.768115, places);
