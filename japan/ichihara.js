...
function ichihara() {
    ...
    const places = [
        { name: "Святилище Инадзума", coordinates: { lat: 35.5146, lng: 140.1135 } },
        { name: "Храм Бенедиктина Ицукадзи", coordinates: { lat: 35.5190, lng: 140.0578 } },
        { name: "Храм Ичихара", coordinates: { lat: 35.5081, lng: 140.1140 } },
        { name: "Парк Итакура", coordinates: { lat: 35.5604, lng: 140.1165 } },
        { name: "Ичихара Суикин-Коэн", coordinates: { lat: 35.5459, lng: 140.0703 } }
      ];
    ...
    const map = createMap(35.538817, 139.930254, places);
