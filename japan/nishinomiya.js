...
function nishinomiya() {
    ...
    const places = [
        { name: "Замок Кокура", coordinates: { lat: 33.8828, lng: 130.8725 } },
        { name: "Ботанический сад Яхата", coordinates: { lat: 33.8744, lng: 130.8155 } },
        { name: "Музей истории Кокуры", coordinates: { lat: 33.8834, lng: 130.8741 } },
        { name: "Остров Мойсаки", coordinates: { lat: 33.9009, lng: 130.9117 } },
        { name: "Парк Такано", coordinates: { lat: 33.8394, lng: 130.7066 } }
      ];
    ...
    const map = createMap(34.755854, 135.361061, places);
