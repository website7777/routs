...
function lucknow() {
    ...
    const places = [
        { name: "Bara Imambara", coordinates: { lat: 26.8602, lng: 80.9340 } },
        { name: "Chota Imambara", coordinates: { lat: 26.8745, lng: 80.9187 } },
        { name: "Rumi Darwaza", coordinates: { lat: 26.8782, lng: 80.9146 } },
        { name: "Ambedkar Memorial Park", coordinates: { lat: 26.8474, lng: 81.0036 } },
        { name: "Hazratganj", coordinates: { lat: 26.8539, lng: 80.9370 } }
      ];
      
      
      const map = createMap(26.8467, 80.9462, places);
