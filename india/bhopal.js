...
function bhopal() {
    ...
    const places = [
        { name: "Upper Lake", coordinates: { lat: 23.2315, lng: 77.4321 } },
        { name: "Bhimbetka Rock Shelters", coordinates: { lat: 22.9511, lng: 77.5932 } },
        { name: "Van Vihar National Park", coordinates: { lat: 23.2146, lng: 77.3931 } },
        { name: "Taj-ul-Masajid", coordinates: { lat: 23.2639, lng: 77.3969 } },
        { name: "Gohar Mahal", coordinates: { lat: 23.2581, lng: 77.3972 } }
      ];
      ...
      const map = createMap(23.2599, 77.4126, places);
