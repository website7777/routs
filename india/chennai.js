...
function chennai() {
    ...
    const places = [
        { name: "Marina Beach", coordinates: { lat: 13.0499, lng: 80.2826 } },
        { name: "Kapaleeshwarar Temple", coordinates: { lat: 13.0337, lng: 80.2717 } },
        { name: "Fort St. George", coordinates: { lat: 13.0806, lng: 80.2870 } },
        { name: "San Thome Basilica", coordinates: { lat: 13.0362, lng: 80.2741 } },
        { name: "Guindy National Park", coordinates: { lat: 13.0084, lng: 80.2206 } }
      ];
    ...
    const map = createMap(13.0827, 80.2707, places);
