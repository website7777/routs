...
function pimpriChinchwad() {
    ...
    const places = [
        { name: "Appu Ghar", coordinates: { lat: 18.6276, lng: 73.8033 } },
        { name: "Bird Valley Udyan", coordinates: { lat: 18.6151, lng: 73.8024 } },
        { name: "Nisargakavi Bahinabai Chaudhary Zoo", coordinates: { lat: 18.6581, lng: 73.8008 } },
        { name: "Shri Swami Samarth Math", coordinates: { lat: 18.6462, lng: 73.8136 } },
        { name: "Morya Gosavi Ganpati Mandir", coordinates: { lat: 18.6206, lng: 73.8133 } }
      ];
      ...
      const map = createMap(18.6279, 73.8003, places);
