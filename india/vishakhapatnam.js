...
function vishakhapatnam() {
    ...
    const places = [
        { name: "RK Beach", coordinates: { lat: 17.7228, lng: 83.3310 } },
        { name: "Kailasagiri", coordinates: { lat: 17.7674, lng: 83.3474 } },
        { name: "Borra Caves", coordinates: { lat: 18.3131, lng: 83.8461 } },
        { name: "Simhachalam Temple", coordinates: { lat: 17.7643, lng: 83.2487 } },
        { name: "Indira Gandhi Zoological Park", coordinates: { lat: 17.7679, lng: 83.3354 } }
      ];
      ...
      const map = createMap(17.6868, 83.2185, places);
