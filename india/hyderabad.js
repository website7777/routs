...
function hyderabad() {
    ...
    const places = [
        ...
        { name: "Golkonda Fort", coordinates: { lat: 17.3833, lng: 78.4011 } },
        { name: "Hussain Sagar Lake", coordinates: { lat: 17.4239, lng: 78.4738 } },
        { name: "Ramoji Film City", coordinates: { lat: 17.2543, lng: 78.6800 } },
        { name: "Salar Jung Museum", coordinates: { lat: 17.3713, lng: 78.4804 } }
      ];
    ...
    const map = createMap(17.3850, 78.4867, places);
