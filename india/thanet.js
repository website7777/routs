...
function thanet() {
    ...
    const places = [
        { name: "Margate Beach", coordinates: { lat: 51.3813, lng: 1.3862 } },
        { name: "Turner Contemporary", coordinates: { lat: 51.3834, lng: 1.3866 } },
        { name: "Dreamland Margate", coordinates: { lat: 51.3815, lng: 1.3860 } },
        { name: "Shell Grotto", coordinates: { lat: 51.3795, lng: 1.3911 } },
        { name: "Botany Bay", coordinates: { lat: 51.3761, lng: 1.4343 } }
      ];
      ...
      const map = createMap(51.3602, 1.3863, places);
