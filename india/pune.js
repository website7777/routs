...
function pune() {
    ...
    const places = [
        { name: "Shaniwar Wada", coordinates: { lat: 18.5196, lng: 73.8553 } },
        { name: "Aga Khan Palace", coordinates: { lat: 18.5549, lng: 73.9169 } },
        { name: "Sinhagad Fort", coordinates: { lat: 18.3595, lng: 73.7517 } },
        { name: "Raja Dinkar Kelkar Museum", coordinates: { lat: 18.5109, lng: 73.8542 } },
        { name: "Pataleshwar Cave Temple", coordinates: { lat: 18.5158, lng: 73.8443 } }
      ];
      
      const map = createMap(18.5204, 73.8567, places);
