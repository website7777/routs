...
function delhi() {
    ...
    const places = [
        { name: "Red Fort", coordinates: { lat: 28.6562, lng: 77.2410 } },
        { name: "India Gate", coordinates: { lat: 28.6129, lng: 77.2295 } },
        { name: "Qutub Minar", coordinates: { lat: 28.5245, lng: 77.1855 } },
        { name: "Lotus Temple", coordinates: { lat: 28.5535, lng: 77.2588 } },
        { name: "Akshardham Temple", coordinates: { lat: 28.6127, lng: 77.2773 } }
      ];
      
      
    
  
    const map = createMap(28.6139, 77.2090, places);
