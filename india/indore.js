...
function indore() {
    ...
    const places = [
        { name: "Rajwada Palace", coordinates: { lat: 22.7196, lng: 75.8577 } },
        { name: "Sarafa Bazaar", coordinates: { lat: 22.7199, lng: 75.8795 } },
        { name: "Kanch Mandir", coordinates: { lat: 22.7237, lng: 75.8667 } },
        { name: "Central Museum Indore", coordinates: { lat: 22.7154, lng: 75.8574 } },
        { name: "Patalpani Waterfall", coordinates: { lat: 22.8164, lng: 75.6667 } }
      ];
      ...
      const map = createMap(22.7196, 75.8577, places);
