...
function vadodara() {
    ...
    const places = [
        { name: "Laxmi Vilas Palace", coordinates: { lat: 22.3072, lng: 73.1812 } },
        { name: "Sayaji Gardens", coordinates: { lat: 22.3156, lng: 73.1714 } },
        { name: "Kirti Mandir", coordinates: { lat: 22.3049, lng: 73.1792 } },
        { name: "EME Temple", coordinates: { lat: 22.3177, lng: 73.1874 } },
        { name: "Vadodara Museum & Picture Gallery", coordinates: { lat: 22.3130, lng: 73.1677 } }
      ];
      ...
      const map = createMap(22.3072, 73.1812, places);
