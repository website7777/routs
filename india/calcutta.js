...
function calcutta() {
    ...
    const places = [
        { name: "Victoria Memorial", coordinates: { lat: 22.5448, lng: 88.3426 } },
        { name: "Howrah Bridge", coordinates: { lat: 22.5851, lng: 88.3468 } },
        { name: "Indian Museum", coordinates: { lat: 22.5597, lng: 88.3510 } },
        { name: "Belur Math", coordinates: { lat: 22.6324, lng: 88.3619 } },
        { name: "Dakshineswar Kali Temple", coordinates: { lat: 22.6556, lng: 88.3571 } }
      ];
    ...
    const map = createMap(22.5726, 88.3639, places);
