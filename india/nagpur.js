...
function nagpur() {
    ...
    const places = [
        { name: "Deekshabhoomi", coordinates: { lat: 21.1290, lng: 79.0460 } },
        { name: "Ambazari Lake", coordinates: { lat: 21.1588, lng: 79.0577 } },
        { name: "Futala Lake", coordinates: { lat: 21.1395, lng: 79.0548 } },
        { name: "Seminary Hill", coordinates: { lat: 21.1676, lng: 79.0690 } },
        { name: "Raman Science Centre", coordinates: { lat: 21.1444, lng: 79.0609 } }
      ];
      
      
      
      
      const map = createMap(21.1458, 79.0882, places);
