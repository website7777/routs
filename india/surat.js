...
function surat() {
    ...
    const places = [
        { name: "Dutch Garden", coordinates: { lat: 21.1938, lng: 72.8087 } },
        { name: "Sardar Patel Museum", coordinates: { lat: 21.1906, lng: 72.8081 } },
        { name: "Gopi Talav", coordinates: { lat: 21.1953, lng: 72.8303 } },
        { name: "ISKCON Surat", coordinates: { lat: 21.1985, lng: 72.7981 } },
        { name: "Science Center Surat", coordinates: { lat: 21.1992, lng: 72.8219 } }
      ];
    ...
    const map = createMap(21.1702, 72.8311, places);
