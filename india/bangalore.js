...
function bangalore() {
    ...
    const places = [
        { name: "Bangalore Palace", coordinates: { lat: 12.9984, lng: 77.5920 } },
        { name: "Lalbagh Botanical Garden", coordinates: { lat: 12.9507, lng: 77.5848 } },
        { name: "Cubbon Park", coordinates: { lat: 12.9762, lng: 77.5907 } },
        { name: "ISKCON Temple Bangalore", coordinates: { lat: 13.0093, lng: 77.5510 } },
        { name: "Bannerghatta National Park", coordinates: { lat: 12.8000, lng: 77.5770 } }
      ];
    ...
    const map = createMap(12.9716, 77.5946, places);
