...
function davao() {
    ...
    const places = [
        { name: "People's Park", coordinates: { lat: 7.0712, lng: 125.6115 } },
        { name: "Eden Nature Park and Resort", coordinates: { lat: 7.1391, lng: 125.4649 } },
        { name: "Dahican Beach", coordinates: { lat: 6.8019, lng: 126.1028 } },
        { name: "Philippine Eagle Center", coordinates: { lat: 7.1200, lng: 125.6128 } },
        { name: "Malagos Garden Resort", coordinates: { lat: 7.2050, lng: 125.4125 } }      
      ];
      
  
    const map = createMap(7.1907, 125.4553, places);
