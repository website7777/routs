...
function san_juan() {
    ...
    const places = [
        { name: "Redemptorist Church", coordinates: { lat: 14.5371, lng: 120.9943 } },
        { name: "Baclaran Church", coordinates: { lat: 14.5364, lng: 120.9945 } },
        { name: "Solaire Resort & Casino", coordinates: { lat: 14.5289, lng: 120.9835 } },
        { name: "City of Dreams Manila", coordinates: { lat: 14.5325, lng: 120.9871 } },
        { name: "SM Mall of Asia", coordinates: { lat: 14.5354, lng: 120.9827 } }
      ];
      const map = createMap(14.5294, 120.9940, places);
