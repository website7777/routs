...
function san_juan() {
    ...
    const places = [
        { name: "Magellan's Cross", coordinates: { lat: 10.2957, lng: 123.9053 } },
        { name: "Basilica del Santo Niño", coordinates: { lat: 10.2963, lng: 123.9023 } },
        { name: "Fort San Pedro", coordinates: { lat: 10.2925, lng: 123.9052 } },
        { name: "Taoist Temple", coordinates: { lat: 10.3301, lng: 123.8987 } },
        { name: "Cebu Metropolitan Cathedral", coordinates: { lat: 10.2944, lng: 123.9050 } }
      ];
      const map = createMap(10.3157, 123.8854, places);
