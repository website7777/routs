...
function san_juan() {
    ...
    const places = [
        { name: "Forest Camp Nature Resort", coordinates: { lat: 7.9012, lng: 125.0309 } },
        { name: "Valencia Waterfalls", coordinates: { lat: 7.8850, lng: 125.0561 } },
        { name: "Casaroro Falls", coordinates: { lat: 9.3876, lng: 123.2339 } },
        { name: "Gawahon Eco Park", coordinates: { lat: 9.3465, lng: 123.2444 } },
        { name: "Red Rock Hot Spring", coordinates: { lat: 9.3807, lng: 123.1891 } }
      ];
      const map = createMap(9.2897, 123.2881, places);
