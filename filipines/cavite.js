...
function san_juan() {
    ...
    const places = [
        { name: "People's Park in the Sky", coordinates: { lat: 14.1075, lng: 120.9281 } },
        { name: "Puzzle Mansion Bed & Breakfast", coordinates: { lat: 14.1090, lng: 120.9380 } },
        { name: "Sky Ranch Tagaytay", coordinates: { lat: 14.1151, lng: 120.9621 } },
        { name: "The Flower Farm at the Palace in the Sky", coordinates: { lat: 14.1108, lng: 120.9346 } },
        { name: "Island Cove Hotel and Leisure Park", coordinates: { lat: 14.4252, lng: 120.9096 } }
      ];
      const map = createMap(14.4823, 120.9160, places);
