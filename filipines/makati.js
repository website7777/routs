...
function san_juan() {
    ...
    const places = [
        { name: "Ayala Triangle Gardens", coordinates: { lat: 14.5578, lng: 121.0252 } },
        { name: "Greenbelt Park", coordinates: { lat: 14.5516, lng: 121.0260 } },
        { name: "Washington Sycip Park", coordinates: { lat: 14.5566, lng: 121.0245 } },
        { name: "Jaime C. Velasquez Park (Salcedo Park)", coordinates: { lat: 14.5611, lng: 121.0317 } },
        { name: "Ayala Museum Garden", coordinates: { lat: 14.5587, lng: 121.0215 } }
      ];
      const map = createMap(14.5547, 121.0244, places);
