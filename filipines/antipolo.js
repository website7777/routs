...
function san_juan() {
    ...
    const places = [
        { name: "Hinulugang Taktak", coordinates: { lat: 14.6329, lng: 121.1757 } },
        { name: "Pinto Art Museum", coordinates: { lat: 14.6291, lng: 121.1719 } },
        { name: "Mystical Cave", coordinates: { lat: 14.5927, lng: 121.1913 } },
        { name: "Boso-Boso Church and Cave", coordinates: { lat: 14.6079, lng: 121.2093 } },
        { name: "Mount Purro Nature Reserve", coordinates: { lat: 14.6023, lng: 121.2720 } }
      ];
      const map = createMap(14.6255, 121.1245, places);
