...
function san_juan() {
    ...
    const places = [
        { name: "Bonifacio High Street", coordinates: { lat: 14.5501, lng: 121.0503 } },
        { name: "Venice Grand Canal Mall", coordinates: { lat: 14.5357, lng: 121.0429 } },
        { name: "Mind Museum", coordinates: { lat: 14.5509, lng: 121.0453 } },
        { name: "Track 30th", coordinates: { lat: 14.5411, lng: 121.0484 } },
        { name: "American Cemetery and Memorial", coordinates: { lat: 14.5373, lng: 121.0413 } }
      ];
      const map = createMap(14.5284, 121.0637, placesTaguig);
