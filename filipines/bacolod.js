...
function san_juan() {
    ...
    const places = [
        { name: "The Ruins", coordinates: { lat: 10.6805, lng: 122.9622 } },
        { name: "Bacolod Public Plaza", coordinates: { lat: 10.6667, lng: 122.9497 } },
        { name: "Campuestohan Highland Resort", coordinates: { lat: 10.5434, lng: 123.0685 } },
        { name: "Mambukal Hot Springs", coordinates: { lat: 10.5283, lng: 122.9826 } },
        { name: "Negros Forests and Ecological Foundation", coordinates: { lat: 10.7051, lng: 122.9773 } }
      ];
      const map = createMap(10.6782, 122.9595, places);
