...
function san_juan() {
    ...
    const places = [
        { name: "Pinaglabanan Shrine", coordinates: { lat: 14.5983, lng: 121.0292 } },
  { name: "Greenhills Shopping Center", coordinates: { lat: 14.6033, lng: 121.0463 } },
  { name: "Wack-Wack Golf and Country Club", coordinates: { lat: 14.5763, lng: 121.0464 } },
  { name: "Music Museum", coordinates: { lat: 14.6013, lng: 121.0456 } },
  { name: "St. John the Baptist Parish", coordinates: { lat: 14.6026, lng: 121.0384 } }
     ];
      
  
    const map = createMap(14.5980, 121.0350, places);
