...
function san_juan() {
    ...
    const places = [
        { name: "Bakhawan Eco-Park", coordinates: { lat: 11.7217, lng: 122.3833 } },
        { name: "Pastrana Park", coordinates: { lat: 11.7064, lng: 122.3706 } },
        { name: "Magsaysay Park", coordinates: { lat: 11.7081, lng: 122.3667 } },
        { name: "Kalibo Cathedral", coordinates: { lat: 11.7088, lng: 122.3644 } },
        { name: "Aklan Freedom Shrine", coordinates: { lat: 11.7081, lng: 122.3641 } }
      ];
      const map = createMap(11.7081, 122.3644, places);
