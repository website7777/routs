...
function tokyo() {
    ...
    const places = [
      { name: "Rizal Memorial Sports Complex", coordinates: { lat: 14.5326, lng: 120.9907 } },
      { name: "Villamor Air Base Golf Course", coordinates: { lat: 14.5183, lng: 121.0166 } },
      { name: "Upside Down Museum", coordinates: { lat: 14.5370, lng: 120.9935 } },
      { name: "Cuneta Astrodome", coordinates: { lat: 14.5332, lng: 121.0141 } },
      { name: "Cultural Center of the Philippines Complex", coordinates: { lat: 14.5560, lng: 120.9823 } }
    ];
    const map = createMap(14.5378, 121.0011, places);
