...
function tapa() {
    ...
    const places = [
        { name: "Тапская гимназия", coordinates: { lat: 59.2596, lng: 25.9822 } },
        { name: "Тапская библиотека", coordinates: { lat: 59.2557, lng: 25.9728 } },
        { name: "Тапская церковь", coordinates: { lat: 59.2544, lng: 25.9641 } },
        { name: "Тапская площадь", coordinates: { lat: 59.2573, lng: 25.9780 } },
        { name: "Тапская школа", coordinates: { lat: 59.2624, lng: 25.9857 } }
      ];
    
    
  
    const map = createMap(59.2590, 25.9780, places);
