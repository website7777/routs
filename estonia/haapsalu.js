...
function haapsalu() {
    ...
    const places = [
        { name: "Хаапсалу замок", coordinates: { lat: 58.9488, lng: 23.5407 } },
    { name: "Хаапсалу ратуша", coordinates: { lat: 58.9441, lng: 23.5419 } },
    { name: "Хаапсалу церковь", coordinates: { lat: 58.9429, lng: 23.5404 } },
    { name: "Хаапсалу гимназия", coordinates: { lat: 58.9458, lng: 23.5417 } },
    { name: "Хаапсалу библиотека", coordinates: { lat: 58.9433, lng: 23.5433 } }
 
      ];
  
    const map = createMap(58.9448, 23.5414, places);
