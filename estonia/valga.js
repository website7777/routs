...
function voru() {
    ...
    const places = [
        { name: "Замок Валга", coordinates: { lat: 57.7775, lng: 26.0407 } },
    { name: "Валгаская ратуша", coordinates: { lat: 57.7754, lng: 26.0443 } },
    { name: "Валгаская церковь", coordinates: { lat: 57.7746, lng: 26.0427 } },
    { name: "Валгаская гимназия", coordinates: { lat: 57.7766, lng: 26.0411 } },
       ];
    
  
    const map = createMap(57.77882, 26.04429, places);
