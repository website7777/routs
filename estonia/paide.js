...
function paide() {
    ...
    const places = [
        { name: "Пайдеский замок", coordinates: { lat: 58.8850, lng: 25.5629 } },
        { name: "Пайдеская ратуша", coordinates: { lat: 58.8869, lng: 25.5565 } },
        { name: "Пайдеская церковь", coordinates: { lat: 58.8864, lng: 25.5604 } },
        { name: "Пайдеская гимназия", coordinates: { lat: 58.8885, lng: 25.5551 } },
        { name: "Пайдеская библиотека", coordinates: { lat: 58.8881, lng: 25.5632 } }
      ];
    
    
  
    const map = createMap(58.8870, 25.5585, places);
