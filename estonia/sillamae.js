...
function sillamae() {
    ...
    const places = [
        { name: "Силламяэская гимназия", coordinates: { lat: 59.4107, lng: 27.7720 } },
        { name: "Силламяэская библиотека", coordinates: { lat: 59.4156, lng: 27.8327 } },
        { name: "Силламяэская церковь", coordinates: { lat: 59.4131, lng: 27.8191 } },
        { name: "Силламяэская площадь", coordinates: { lat: 59.4144, lng: 27.8333 } },
        { name: "Силламяэская школа", coordinates: { lat: 59.4112, lng: 27.8240 } }
      ];
  
    const map = createMap(59.4124, 27.8147, places);
