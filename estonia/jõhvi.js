...
function jõhvi() {
    ...
    const places = [
        { name: "Йыхвиская гимназия", coordinates: { lat: 59.3586, lng: 27.4110 } },
        { name: "Йыхвиская библиотека", coordinates: { lat: 59.3619, lng: 27.4085 } },
        { name: "Йыхвиская церковь", coordinates: { lat: 59.3605, lng: 27.4206 } },
        { name: "Йыхвиская площадь", coordinates: { lat: 59.3622, lng: 27.4142 } },
        { name: "Йыхвиская школа", coordinates: { lat: 59.3572, lng: 27.4100 } }
      ];
  
    const map = createMap(59.3594, 27.4131, places);
