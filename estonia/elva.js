...
function elva() {
    ...
    const places = [
        { name: "Элваская гимназия", coordinates: { lat: 58.2216, lng: 26.4237 } },
        { name: "Элваская библиотека", coordinates: { lat: 58.2225, lng: 26.4209 } },
        { name: "Элваская церковь", coordinates: { lat: 58.2221, lng: 26.4191 } },
        { name: "Элваская площадь", coordinates: { lat: 58.2226, lng: 26.4225 } },
        ];
    
    
  
    const map = createMap(58.1325, 26.2458, places);
